...
/* -------------------------------------------------------------------------- */
/* ------------------------------- Jenis Case ------------------------------- */
// 1. camelCase = employeeData, userName, itemPrice
// 2. PascalCase = EmployeeData, UserName, ItemPrice
// 3. snake_case = employee_data, user_name, item_price
// 4. kebab-case = employee-data, user-name, item-price
