...
const userData: IUserData = {
  ...
  printUserData: function () {
    return `Halo. Namaku ${this.name}, umurku ${this.age} tahun, dan aku tinggal di ${this.address.city}`;
  },
};
...
// Object.keys => Untuk mengambil keys dari sebuah object dan diletakkan di sebuah array
...
console.log(userData.hasOwnProperty("salary"));
