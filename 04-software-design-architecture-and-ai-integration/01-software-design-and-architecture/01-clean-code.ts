...
/* -------------------- 2. Meaningul names over comments -------------------- */
// BAD ❌
...
// GOOD ✔
function hasAvailableSeats(totalSeats: number, bookedSeats: number): boolean {
...
// GOOD
function calcuclateTotalRevenue(currentRevenue: number, amount: number) {
